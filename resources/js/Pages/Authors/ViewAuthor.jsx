...
export default function ViewAuthor({ auth }) {
      ...
      <div className="py-12">
        <div className="mx-auto max-w-5xl sm:px-6 lg:px-8">
          ...
          <div className="flex justify-between mt-8">
            <Link className="focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600 block px-12 py-2 text-center text-white text-sm font-semibold hover:bg-orange-500 bg-orange-500 rounded-md shadow-sm" href={route('authors')}>
              ...
              <span className="ml-2">All Authors</span>
              </div>
            </Link>

            {/* Second Button */}
            <Link className="focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 block px-12 py-2 text-center text-white text-sm font-semibold hover:bg-red-500 bg-red-500 rounded-md shadow-sm" href={route('updateauthor', author.id)}>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
              ...
              <span className="ml-2">Edit Author</span>
              </div>
            </Link>
          </div>
